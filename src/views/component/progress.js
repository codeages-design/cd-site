...
<div class="cd-progress cd-progress-danger">
  ...
  <div class="progress-text"><i class="cd-icon cd-icon-danger cd-text-sm cd-text-danger"></i></div>
</div>
`;
...
<div class="cd-progress">
  <div class="progress-bar">
    <div class="progress-outer">
      <div class="progress-inner active" style="width: 50%;"></div> 
    </div>
  </div>
  <div class="progress-text">50%</div>
</div>
...
<div class="cd-progress cd-progress-lg">
  <div class="progress-bar">
    <div class="progress-outer">
